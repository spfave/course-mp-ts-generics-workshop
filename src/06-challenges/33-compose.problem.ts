...
// Attempt with generic utility function type for more generic function capture
// type Func<P extends any[], R> = (...args: P) => R;
// export function compose<T1 extends any[], T2>(func1: Func<T1, T2>): Func<T1, T2>;
// export function compose<T1 extends any[], T2 extends any[], T3>(
//   func1: Func<T1, T2>,
//   func2: Func<T2, T3>,
// ): Func<T1, T3>;
